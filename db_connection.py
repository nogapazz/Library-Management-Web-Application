...
def db_connector(db_name):
    ...
    app.config['MYSQL_DATABASE_USER'] = 'your sql username'  #username
    app.config['MYSQL_DATABASE_PASSWORD'] = 'your sql password' #password
    app.config['MYSQL_DATABASE_DB'] = 'your scheme' #database name
